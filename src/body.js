...
const Card=(props)=>{
    return <div className="card">
      <img className="img" src={"https://source.unsplash.com/1600x800/?"+props.data.meetImg}></img>
...
const Body=()=>{
 ...
 async function meetData(){
    const Data=await fetch("https://shedlule-default-rtdb.firebaseio.com/newapp.json")
